...
Uses subprocess to run Playwright for JavaScript-rendered content (avoids threading issues).
"""
...
class CourseScraper:
    ...
    def _extract_video_via_subprocess(self, url: str) -> Optional[dict]:
        ...
        try:
            ...
            extractor_path = os.path.join(script_dir, 'wistia_extractor.py')
            ...
            # Run the extractor as a subprocess
            print(f"  Running Playwright extractor...")
    ...
    def get_lesson_details(self, lesson: Lesson, progress_callback: Optional[Callable] = None) -> Lesson:
        ...
        try:
            ...
            # Get HTML content via HTTP for file detection
